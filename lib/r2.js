...
async function listObjectsWithSize(prefix) {
  ...
  // S3-compatible APIs return keys in lexicographic order already, but sort
  // explicitly (matching listObjects) rather than rely on that implicitly -
  // chunk concatenation order depends on this being correct.
